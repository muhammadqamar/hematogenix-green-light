...
import { AddInventory, DeleteInventory,DeletePurple,  EditColor, SearchColor, ExpiryAlertPurple } from '../../../HemeIconLibrary';
...
const SystemUserList = ({ setCTA, setformName, setFormIcon, setUpdatedData, setokBtnText, setokBtnIcon }) => {
                  ...
                  return (
                    <div className="flex">
                      <div className="flex justify-end gap-[5px] meta">
                        ...
                        />
                        <Button Icon={<SearchColor />} padding={false} color="text-white" bg="bg-bgActionDots" />
                        <Button
